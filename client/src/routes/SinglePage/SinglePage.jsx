      ...
      <div className="content">
        ...
        <div className="text-content">
          <div className="property-details">
            ...
            <div className="amenities">
              ...
              <div className="amenity-wrapper">
                <div className="amenity"><FaWifi />{postDetail.amenities === "yes" ? "Yes" : postDetail.amenities === "no" ? "No" : "Not Sure"}</div>
              </div>
            </div>
          ...
          <div className="author">
            {post.user && (
              <>
                <img src={post.user.avatar || './avatar.jpg'} alt={`${post.user.username}'s avatar`} />
        ...
        {currentUser?.id === post.userId && (
          <> 
            <button className="updateButton" onClick={() => navigate(`/${post.id}/update`)}>Update Listing</button>
